function love.conf(t)
    ...
    t.title = "HOX"        -- The title of the window the game is in (string)
    t.author = "Daniël Haazen"        -- The author of the game (string)
    t.url = "www.desura.com/games/hox or www.danielhaazen.com"                 -- The website of the game (string)          -- The name of the save directory (string)
